  ...
  return (
    <div className="hero mb-[60px] mt-[60px] bg-base-200">
      <div className="hero-content flex-col lg:flex-row">
        ...
        />
        <div>
          <h1 data-aos="fade-down-left" className="text-5xl font-bold">Welcome to Sajib Industrial</h1>
          ...
          <button data-aos="fade-down-left" className="btn bg-[#fc5a34] text-white rounded-none hover:bg-[#000]">
            Learn More
          </button>
        </div>
      </div>
